    ...
    <div>
        <div class="min-h-screen flex bg-gray-100">
            ...
            <div class="flex-1 h-screen flex flex-col overflow-y-auto">
                <!-- <nav
                    class="border-b border-gray-100 bg-white h-20 flex items-center"
                >
                    <div class="flex-1 px-8">
                        <div class="flex h-16 justify-between">
                            <div class="flex">
                                ...
                                <div
                                    class=" space-x-8 sm:flex items-center"
                                >
                ...
                <!-- Page Heading -->
                <header
                    class="px-8 pb-6 pt-4 sticky top-0 flex items-center bg-gray-100 z-50"
                    v-if="$slots.header"
                >
